...
int DistArray[50];    //Variables for the Median Test
int median = 0;
int number = 0;
...
void loggingDistance(){
  ...
  if (myFile) {
    ...
    myFile.println(median); //print the median of 50 distance readings into the TEST.txt file
  }
  myFile.close(); //close the file
...
//Change measurement frequency here
